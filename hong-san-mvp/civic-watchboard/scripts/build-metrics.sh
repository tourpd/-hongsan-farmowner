...
cp -v "$OUT_MONTH" "$PUB_DIR/out_card_month.csv" >/dev/null
cp -v "$OUT_YEAR" "$PUB_DIR/out_card_year.csv" >/dev/null
cp -v "$OUT_YEAR_PIVOT" "$PUB_DIR/out_card_year_pivot.csv" >/dev/null
cp -v "$OUT_BUDGET" "$PUB_DIR/out_card_budget.csv" >/dev/null
